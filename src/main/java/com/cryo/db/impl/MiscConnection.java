...
public class MiscConnection extends DatabaseConnection {
    ...
    public static MiscConnection connection() {
        return (MiscConnection) Main.getInstance().getConnectionManager().getConnection(DBConnectionManager.Connection.MISC);
    }
    ...
    public static void setInt(String key, int value) {
        connection().handleRequest("set-value", key, Integer.toString(value));
    }
    ...
    public static void setString(String key, String value) {
        connection().handleRequest("set-value", key, value);
    }
